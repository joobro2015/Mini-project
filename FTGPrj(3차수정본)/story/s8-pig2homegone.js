...
printSubtitle(ctx) {
  ...
  ctx.fillText('그러자 이번에도 늑대는 입김을 모으기 시작했어요.', 200, 400);
  ctx.fillText(' "후우우우 훅훅~!"', 200, 440);
  ctx.fillText('이번에도 늑대는 입김을 훅 불어 나무로 만든', 200, 480);
  ctx.fillText('둘째 돼지 집을 휙 날려버렸어요.', 200, 520);                       
